...
const useHealthConnect = () => {
  ...
  const fetchData = useCallback(
    async (grantedPermissions?: Permission[]) => {
      ...
      try {
        ...
        const totalSleep = sleepRecords.reduce((sum, cur) => {
  ...
  const revokeAccess = useCallback(() => {
    ...
    Alert.alert(
      "Access Revoked",
      "Permissions cleared locally. To fully revoke, open the Health Connect app, go to Lusie, and remove access for this app.",
      [
        {
